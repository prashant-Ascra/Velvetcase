 ...
 */
public class DiscoverSimilarAdapter  extends RecyclerView.Adapter<DiscoverSimilarAdapter.ContactViewHolder> {
...
WishListDBHelper wlDBHelper;
    ...
    public DiscoverSimilarAdapter( ArrayList<Products> productList,Activity context) {
    ...
    public DiscoverSimilarAdapter(Activity Act) {
        this.context = Act;
    }
...
//        }
    ...
    public static class ContactViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,GetResponse {
        ...
        public void onClick(View v) {
            ...
            if (v == card_view) {
                AllProductsModelBase.getInstance().setProductSelectionFlag("Discover");
