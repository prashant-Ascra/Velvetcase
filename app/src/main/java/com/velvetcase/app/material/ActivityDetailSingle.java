...
import me.drakeet.materialdialog.MaterialDialog;
    ...
    public class ActivityDetailSingle extends ActionBarActivity implements View.OnClickListener,GetResponse {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            wlDBHelper=new WishListDBHelper(ActivityDetailSingle.this);
...
//        }
           ProductSelectionFlag= AllProductsModelBase.getInstance().getProductSelectionFlag();
                ...
                if (mainProduct!= null){
                    ...
                    try {
                        ...
                        for (int k=0; k<stoneArray.length(); k++){
                            SPEC1 = new TextView(ActivityDetailSingle.this);
                            SPEC2 = new TextView(ActivityDetailSingle.this);
...
//                            piecesArray.getString(0));
                        ...
                        adapter = new ImageSliderListAdapter(ActivityDetailSingle.this, ImageList);
        ...
        public void onClick(View v) {
                ...
                set.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        if(mainProduct.get_wish_list_flag()){
                            ...
                            AllProductsModelBase.getInstance().UpdateSingleDesignerListData(mainProduct.getproduct_id(), false);
                            // heartFlag = false;
                            ExecuteServerRequest(+mainProduct.getproduct_id(),false);
                        }else{

                            //   shop_layout.setVisibility(View.GONE);
                            //   heart_icon.setImageResource(R.drawable.heart_icon);

                            AllProductsModelBase.getInstance().UpdateSingleDesignerListData(mainProduct.getproduct_id(), true);
                            //   heartFlag = true;
            ...
            if(img_metals == v || txt_metals == v  ){
                ...
                menuFlag = true;
                applyScaleAnimation(bag_icon);
                Intent i = new Intent(ActivityDetailSingle.this,Shopdetail.class);
                startActivity(i);
            }
            if(img_price == v || txt_price == v ){
                ...
                menuFlag = true;
                applyScaleAnimation(bag_icon);
                Intent i = new Intent(ActivityDetailSingle.this,PriceFilterActivity.class);
                startActivity(i);
            }
            if (txt_shopnow == v){
                OpenBrowser(mainProduct.getshop_url());
            } else if (txt_discover_similar == v){
                Intent i = new Intent(ActivityDetailSingle.this,DiscoverSimilarActivity.class);
                i.putExtra("ActionbarTitle","Discover Similar");
                startActivity(i);
            } else if (txt_discover_new == v){
                Intent i = new Intent(ActivityDetailSingle.this,DiscoverNewActivtiy.class);
        ...
        public void ExecuteServerRequest(int p_id,Boolean flag){
            ...
            asyncReuse = new AsyncReuse(ActivityDetailSingle.this, Constants.APP_MAINURL+"tokens/product_wishlist", Constants.POST, paramslist, false);
