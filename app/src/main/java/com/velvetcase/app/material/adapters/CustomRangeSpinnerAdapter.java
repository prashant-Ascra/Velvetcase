 ...
 */
public class CustomRangeSpinnerAdapter extends BaseAdapter {
    private List<String> mItems = new ArrayList<>();
    Activity activity;
    public CustomRangeSpinnerAdapter(Activity mainActivity) {
    ...
    public View getDropDownView(int position, View view, ViewGroup parent) {
        if (view == null || !view.getTag().toString().equals("DROPDOWN")) {
            view = activity.getLayoutInflater().inflate(R.layout.custom_range_row, parent, false);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        if (view == null || !view.getTag().toString().equals("NON_DROPDOWN")) {
            view = activity.getLayoutInflater().inflate(R.layout.
                    custom_range_row_actionbar, parent, false);
