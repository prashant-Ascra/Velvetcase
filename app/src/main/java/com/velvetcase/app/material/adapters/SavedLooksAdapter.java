...
/**
 * Created by Prashant Patil on 30-06-2015.
 */
public class SavedLooksAdapter extends RecyclerView.Adapter<SavedLooksAdapter.CntViewHolder> implements GetResponse {
    ...
    public SavedLooksAdapter(JSONArray lookslist,Activity context, getproduct_id get_id) {
        this.lookslist = lookslist;
        this.context = context;
        this.get_id=get_id;
    }

    public SavedLooksAdapter(MainActivity Act) {
        this.activity = Act;
    }
        ...
        public void onClick(View v) {
            if(main_layout == v){
                try {
                    ...
                    AllProductsModelBase.getInstance().setTemplateSelectionFlag("SavedLooksFlag");
